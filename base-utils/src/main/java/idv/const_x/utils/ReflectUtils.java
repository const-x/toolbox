...
public class ReflectUtils {
	 ...
	 * @return
	 */
	public static List<Field> getFields(Object obj, boolean includSupers) {
	 ...
	 * @throws IllegalAccessException
	 */
	public static void setStaticFinalValueByFieldName(Class claz, String fieldName,
			Object value) throws SecurityException, NoSuchFieldException,
			IllegalArgumentException, IllegalAccessException {
    ...
    public static Set<Class<?>> getClzFromPkg(String pkg) {
     //第一个class类的集合
        ...
        try {
            Enumeration<URL> urls = ReflectUtils.class.getClassLoader().getResources(pkgDirName);
