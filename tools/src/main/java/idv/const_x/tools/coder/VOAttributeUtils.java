...
public class VOAttributeUtils {
	...
	public static String createPOJOField(String field, String type, String alias,String defaultvalue,String ... annotations){
	...
	// */
	// public String cbrandid = null;
	public static String createPOJOFieldWithProfixe(String field, String type, String alias,String ... profixes){
		StringBuilder str = new StringBuilder();
		if(StringExtUtils.isNotBlank(alias)){
			str.append("/**");
			str.append(alias);
			str.append("*/");
		}
	...
	public static String createGetter(String field, String type, String alias) {
		...
		public static String createGetterInvoke(String field, String type, String alias) {
			...
			str.append(type +" "+ field +" = get" + methodName + "();\n");
			return str.toString();
		}
}
